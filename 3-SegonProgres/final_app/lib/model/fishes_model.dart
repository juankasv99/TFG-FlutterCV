...
Map<String, Fishes> fishesFromJson(String str) => Map.from(json.decode(str)).map((k, v) => MapEntry<String, Fishes>(k, Fishes.fromJson(v)));

String fishesToJson(Map<String, Fishes> data) => json.encode(Map.from(data).map((k, v) => MapEntry<String, dynamic>(k, v.toJson())));
